...
class MarketDataFactory:
    ...
    def create_intraday_data(
        symbol: str = "TEST", date: str = "2023-01-01", interval_minutes: int = 5
    ) -> pd.DataFrame:
        ...
        return pd.DataFrame(
            {"Close": prices, "Volume": np.random.randint(100000, 1000000, n_periods)}, index=times
        )
...
class StrategyFactory:
    ...
    def create_signal(
        ...
        return {
            ...
            "size": 100,
            "metadata": {"strategy": "test_strategy", "indicators": {"RSI": 50, "MACD": 0.5}},
        }
...
class PortfolioFactory:
    ...
    def create_portfolio(
        ...
        portfolio = {"cash": cash, "positions": {}, "total_value": cash, "returns": []}
...
class TradeFactory:
    ...
    def create_trade(
        ...
        return {
            ...
            "status": "FILLED",
            "metadata": {"strategy": "test_strategy", "signal_confidence": 0.8},
        }
