...
from bot_v2.features.live_trade.order_policy import OrderPolicyMatrix
from bot_v2.features.live_trade.pnl_tracker import PnLTracker
from bot_v2.orchestration.coinbase_perps_v2 import PerpetualOrchestrator
...
class Stage3Runner:
    ...
    async def initialize_orchestrator(self):
        ...
        config = {
            ...
            'position_limits': {
                'BTC-PERP': {'max_size': Decimal('0.1'), 'max_notional': Decimal('5000')},
                'ETH-PERP': {'max_size': Decimal('0.1'), 'max_notional': Decimal('300')},
                'SOL-PERP': {'max_size': Decimal('10'), 'max_notional': Decimal('100')},
                'XRP-PERP': {'max_size': Decimal('200'), 'max_notional': Decimal('100')}
            },
