...
def initialize_services(
    ...
    CoinbaseBrokerage = telemetry_module.CoinbaseBrokerage
    CoinbaseAccountManager = telemetry_module.CoinbaseAccountManager
    IntxPortfolioService = telemetry_module.IntxPortfolioService
    AccountTelemetryService = telemetry_module.AccountTelemetryService
    MarketActivityMonitor = telemetry_module.MarketActivityMonitor
