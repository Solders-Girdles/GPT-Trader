...
class ProductFactory:
    ...
    def create_product(self, symbol: str, market_type: MarketType = MarketType.PERPETUAL) -> Product:
        ...
        section_key = "perpetual_products" if market_type == MarketType.PERPETUAL else "spot_products"
