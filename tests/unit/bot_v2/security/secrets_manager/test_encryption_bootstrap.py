...
class TestEncryptionBootstrap:
    ...
    def test_bootstrap_invalid_key_error(
        ...
        # Set invalid key
        monkeypatch.setenv("BOT_V2_ENCRYPTION_KEY", "invalid-key")
    ...
    def test_bootstrap_key_types(
        ...
        monkeypatch.setenv("BOT_V2_ENCRYPTION_KEY", "Z9mB9nKp8sVqLyWsC5uE4oHj7gFdR2aL3xYiN6wTzQc=")
        settings = load_runtime_settings()
        ...
        monkeypatch.setenv("BOT_V2_ENCRYPTION_KEY", bytes_key)
        settings = load_runtime_settings()
