...
from src.bot.ml.model_calibrator import (
    create_model_calibrator, CalibrationConfig
)
from src.bot.ml.performance_targets import (
    create_target_setter, MarketRegime, ModelType
)
from src.bot.ml.threshold_optimizer import (
    create_threshold_optimizer, TradingConstraints, OptimizationObjective
)
...
def test_threshold_optimization():
    ...
    y_prob = np.where(y_true == 1,
                     ...
                     np.random.beta(4, 6, n_samples))  # Lower prob for negative
