...
class LSTMAnomalyDetector:
    ...
    def fit(self, data: Union[np.ndarray, pd.DataFrame], verbose: int = 0):
        """
    ...
    def detect_anomalies(self, data: Union[np.ndarray, pd.DataFrame]) -> Tuple[np.ndarray, np.ndarray]:
        """
    ...
    def predict_next(self, data: Union[np.ndarray, pd.DataFrame], n_steps: int = 1) -> np.ndarray:
        """
    ...
    def save(self, filepath: str):
        ...
        with open(filepath + '_components.pkl', 'wb') as f:
    ...
    def load(self, filepath: str):
        ...
        with open(filepath + '_components.pkl', 'rb') as f:
...
class LSTMEnsembleDetector:
    ...
    def detect_anomalies(self, data: Union[np.ndarray, pd.DataFrame]) -> Tuple[np.ndarray, np.ndarray]:
        ...
        anomaly_probs = np.average(all_anomalies, axis=0, weights=self.weights[:len(all_anomalies)])
