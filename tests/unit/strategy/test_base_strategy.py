...
class TestStrategy:
    ...
    def strategy(self):
        ...
        return ConcreteStrategy(
            name="test_strategy", lookback_period=20, confidence_threshold=0.6
        )

    def test_strategy_initialization(self):
        """Test strategy initialization with parameters."""
        strategy = ConcreteStrategy(
            name="test", lookback_period=30, confidence_threshold=0.7
        )
    ...
    def test_strategy_with_different_parameters(
        self, sample_data, lookback, threshold
    ):
