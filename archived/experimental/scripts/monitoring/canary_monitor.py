...
Archived Usage (restore to `scripts/monitoring/` before running):
  poetry run python scripts/monitoring/canary_monitor.py --duration-minutes 10 --profile canary

  With dashboard:
  poetry run python scripts/monitoring/canary_monitor.py --duration-minutes 15 --profile canary --dashboard
"""
