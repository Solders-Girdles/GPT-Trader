...
def test_sqlalchemy_connection():
    ...
    try:
        from src.bot.database.manager import DatabaseManager, DatabaseConfig
        from src.bot.database.models import (
            Base, Position, Order, Trade, FeatureSet, Model,
            PortfolioSnapshot, Alert
        )
...
def create_initial_data():
    ...
    try:
        ...
        from src.bot.database.models import FeatureSet, Model, Alert, AlertSeverity
