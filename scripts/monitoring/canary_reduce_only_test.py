...
Usage:
  ...
  poetry run python scripts/canary_reduce_only_test.py --live --symbol BTC-PERP --price 10 --qty 0.001
"""
...
def main() -> int:
    ...
    parser.add_argument("--qty", type=float, default=0.001, help="Order quantity")
    ...
    private_key_pem = os.getenv("COINBASE_PROD_CDP_PRIVATE_KEY") or os.getenv("COINBASE_CDP_PRIVATE_KEY")
