"""
Week 2: Strategy filters using WebSocket market data.

Implements liquidity-aware entry gates and RSI confirmation for MA crossover signals.
"""
...
class MarketSnapshot:
    ...
    depth_l1: Optional[Decimal] = None
    depth_l10: Optional[Decimal] = None
...
class LiquidityFilter:
    ...
    def __init__(self, gates: LiquidityGates):
        self.gates = gates
...
class Week2StrategyFilter:
    """Combined Week 2 strategy filters."""
    
    def __init__(self, liquidity_gates: LiquidityGates, enable_rsi: bool = True, per_symbol_gates: Optional[Dict[str, LiquidityGates]] = None):
    ...
    def log_filter_summary(self, snapshot: MarketSnapshot) -> None:
        ...
        if self.rsi_confirmation:
            ...
            logger.info(f"  RSI: {rsi:.1f if rsi else 'N/A'}")
