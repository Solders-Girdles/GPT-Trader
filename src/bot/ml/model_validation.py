...
class ModelValidator:
    ...
    def walk_forward_analysis(self,
                            ...
                            X: pd.DataFrame,
                            y: pd.Series,
                            model_params: Optional[Dict] = None) -> List[ModelPerformance]:
        """
        ...
        for i in range(self.config.min_train_size, 
    ...
    def validate_model(self,
                      ...
                      X_test: pd.DataFrame,
                      y_test: pd.Series,
                      model_name: str = "Unknown") -> ModelPerformance:
        """
    ...
    def _calculate_performance(self,
                             ...
                             n_train: int,
                             n_test: int,
                             training_time: Optional[float] = None) -> ModelPerformance:
...
def create_validator(config: Optional[ValidationConfig] = None) -> ModelValidator:
