...
from bot_v2.orchestration.engines.base import BaseEngine, CoordinatorContext, HealthStatus
from bot_v2.orchestration.configuration import config
...
class TradingEngine(BaseEngine):
    ...
    def __init__(self, context: CoordinatorContext) -> None:
        ...
        from bot_v2.features.brokerages.coinbase.client import SimpleAuth
        import os
