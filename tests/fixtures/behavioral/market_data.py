...
class MarketDataGenerator:
    ...
    def create_price_scenario(
        start_price: Decimal, movements: list[tuple[str, Decimal]]
    ) -> list[Decimal]:
        """
    ...
    def create_funding_scenario(
        base_rate: Decimal = Decimal("0.0001"), variations: list[Decimal] | None = None
    ) -> list[Decimal]:
        """
    ...
    def calculate_impact(
        size: Decimal, order_book: dict[str, list[tuple[Decimal, Decimal]]], side: str
...
class TradeScenarioBuilder:
    ...
    def create_round_trip(
        ...
        entry_size: Decimal,
        exit_price: Decimal,
        funding_payments: list[Decimal] | None = None,
    ) -> dict[str, any]:
        """
        ...
        return {
            ...
            "expected": {"raw_pnl": raw_pnl, "funding": total_funding, "net_pnl": net_pnl},
        }

    @staticmethod
    def create_pyramid_entry(
        base_price: Decimal, base_size: Decimal, increments: list[tuple[Decimal, Decimal]]
    ) -> dict[str, any]:
        """
        ...
        return {"trades": trades, "expected": {"avg_entry": avg_entry, "total_size": total_size}}
...
class RealisticMarketData:
    ...
    @classmethod
    def get_realistic_price_range(
        cls, symbol: str, volatility_multiple: Decimal = Decimal("1")
    ) -> tuple[Decimal, Decimal]:
        """
    ...
    def create_realistic_price_movement(
        cls, symbol: str, direction: str, magnitude: str = "normal"
    ) -> tuple[Decimal, Decimal]:
        """
