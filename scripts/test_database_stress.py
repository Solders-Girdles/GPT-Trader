...
class DatabaseStressTester:
    ...
    def __init__(self):
        ...
        from src.bot.database.models import (
            Position, Order, Trade, FeatureValue,
            Model, Prediction, SystemMetric, Alert
        )
    ...
    def test_time_series_queries(self):
        ...
        for query_name, time_range in queries:
            ...
            try:
                ...
                predictions = self.db.session.query(self.models['Prediction']).filter(
