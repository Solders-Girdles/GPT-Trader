...
class CoinbaseStreamingMixin:
    ...
    def _setup_streaming(self) -> None:
        ...
        try:
            from bot_v2.data_providers import coinbase_provider as compat

            TickerCache = compat.TickerCache  # type: ignore[attr-defined]
            CoinbaseTickerService = compat.CoinbaseTickerService  # type: ignore[attr-defined]
            CoinbaseWebSocket = compat.CoinbaseWebSocket  # type: ignore[attr-defined]
