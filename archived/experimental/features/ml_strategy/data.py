...
def prepare_datasets(
    records: list[StrategyPerformanceRecord], validation_split: float = 0.2
...
def _generate_synthetic_performance(strategy: StrategyName, conditions: MarketConditions) -> dict:
    """
