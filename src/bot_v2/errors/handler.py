...
from . import (
    TradingError, NetworkError, DataError, ExecutionError,
    TimeoutError, handle_error, log_error
)
...
class ErrorHandler:
    ...
    def __init__(
        ...
        fallback_handlers: Optional[Dict[type, Callable]] = None
    ):
    ...
    def _get_fallback(self, error_type: type) -> Optional[Callable]:
    ...
    def _record_error(self, error: TradingError):
