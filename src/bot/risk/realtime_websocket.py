...
class RiskWebSocketServer:
        ...
        try:
            ...
            if msg_type == MessageType.SUBSCRIBE:
                ...
                self.subscriptions[websocket] = {
                    SubscriptionType(st) for st in sub_types
                }
    ...
    async def broadcast(self, message: WebSocketMessage, subscription_type: SubscriptionType = SubscriptionType.ALL):
        """
        ...
        if self.clients:
            ...
            target_clients = [
                ...
                if subscription_type in self.subscriptions.get(client, set()) or
                   SubscriptionType.ALL in self.subscriptions.get(client, set())
            ]
            ...
            if target_clients:
                ...
                await asyncio.gather(
                    *[client.send(message_str) for client in target_clients],
