...
class MetricsExporter:
    ...
    def __init__(self, port: int = 8000):
        ...
        self.datafeed_messages_validated = Counter(
            'datafeed_messages_validated_total',
    ...
    async def update_database_metrics(self):
        ...
        try:
            ...
            self.db_connections_idle.set(pool_status.get('size', 0) - pool_status.get('checked_out', 0))
    ...
    async def update_data_pipeline_metrics(self):
        ...
        try:
            ...
            recent_metrics = self.db.session.query(SystemMetric).filter(
    ...
    async def update_trading_metrics(self):
        ...
        try:
            ...
            open_positions = self.db.session.query(Position).filter(
