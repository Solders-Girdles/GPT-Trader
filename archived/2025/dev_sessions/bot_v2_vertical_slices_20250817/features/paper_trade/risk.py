...
class RiskManager:
    ...
    def update_daily_stats(self, current_equity: float):
        """
    ...
    def get_risk_metrics(self, account: AccountStatus) -> Dict:
        """
        ...
        daily_return = (current_equity - self.last_equity) / self.last_equity if self.last_equity > 0 else 0
        total_return = (current_equity - self.initial_equity) / self.initial_equity if self.initial_equity > 0 else 0
        ...
        return {
            ...
            'risk_utilization': current_drawdown / self.max_drawdown if self.max_drawdown > 0 else 0
        }