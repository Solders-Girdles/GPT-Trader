...
def _replay_fixture() -> dict[str, list[dict[str, str]]]:
    return {
        "candles": [
            _replay_candle(-5, open_="100", high="100", low="100", close="100"),
            _replay_candle(-4, open_="100", high="100", low="100", close="100"),
            _replay_candle(-3, open_="100", high="100", low="100", close="100"),
            _replay_candle(-2, open_="100", high="100", low="100", close="100"),
