"""Helper functions for runtime components to use structured logging with correlation context."""
...
def get_runtime_logger(
    ...
    """Get a logger configured for runtime with correlation support.
    ...
    Returns:
        Logger instance configured for runtime
    """
    if enable_json:
...
def log_trading_operation(
    ...
    **kwargs: Any,
    ...
    """
    logger = get_runtime_logger("trading_operations")
...
def log_order_event(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        **kwargs: Additional context fields
    """
    logger = get_runtime_logger("order_events")
...
def log_strategy_decision(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        **kwargs: Additional context fields
    """
    logger = get_runtime_logger("strategy_decisions")
...
def log_execution_error(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        **kwargs: Additional context fields
    """
    logger = get_runtime_logger("execution_errors")
...
def log_risk_event(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        **kwargs: Additional context fields
    """
    logger = get_runtime_logger("risk_events")
...
def log_market_data_update(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        **kwargs: Additional context fields
    """
    logger = get_runtime_logger("market_data")
...
# Context manager decorators for common runtime patterns
