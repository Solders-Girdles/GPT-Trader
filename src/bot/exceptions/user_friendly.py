...
class StrategyError(UserFriendlyError):
    ...
    def __init__(self, message: str, strategy_name: Optional[str] = None, **kwargs):
        ...
        if strategy_name:
            suggestions.append(f"Run 'gpt-trader backtest --help' to see {strategy_name} parameters")
...
class ErrorHandler:
    ...
    @classmethod
    def handle(cls, error: Exception, context: Optional[str] = None) -> UserFriendlyError:
