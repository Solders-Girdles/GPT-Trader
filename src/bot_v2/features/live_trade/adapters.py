...
def to_core_tif(tif_str: Union[str, CoreTimeInForce]) -> CoreTimeInForce:
    """
...
def to_core_side(side: Union[str, CoreOrderSide]) -> CoreOrderSide:
    """
    ...
    side_map = {
        'buy': CoreOrderSide.BUY,
        'sell': CoreOrderSide.SELL
    }
    return side_map.get(side.lower(), CoreOrderSide.BUY)


def to_core_type(order_type: Union[str, CoreOrderType]) -> CoreOrderType:
    """
...
def to_decimal(value: Union[str, int, float, Decimal, None]) -> Union[Decimal, None]:
    """
