"""
Built-in Runtime Guard Implementations.

Provides standard guard implementations for common trading risk scenarios:
- Daily loss limits
...
from bot_v2.monitoring.runtime_guards.base import GuardConfig, GuardStatus, RuntimeGuard
