...
from .base import MLModel, ComponentConfig
...
class OnlineLearningPipeline:
    ...
    def _is_classification_task(self, targets) -> bool:
        ...
        return len(unique_targets) <= 10 and all(isinstance(t, (int, np.integer)) for t in unique_targets)
...
# Factory function
def create_online_learning_pipeline(config_dict: Optional[Dict] = None) -> OnlineLearningPipeline:
    """
