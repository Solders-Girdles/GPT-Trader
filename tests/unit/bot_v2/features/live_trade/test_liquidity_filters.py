"""Unit tests for liquidity-based strategy filters."""
...
class TestLiquidityFilter:
    ...
    def setup_method(self):
        ...
        gates = LiquidityGates(
            spread_bps_max=20.0, l1_min=Decimal("50"), l10_min=Decimal("500"), vol_1m_min=75.0
        )
...
class TestRSIConfirmation:
    ...
    def setup_method(self):
        ...
        self.rsi = RSIConfirmation(
            period=5, oversold=30.0, overbought=70.0
...
class TestLiquidityStrategyFilter:
    """Test combined liquidity strategy filter logic."""
    ...
    def setup_method(self):
        ...
        self.filter = LiquidityStrategyFilter(gates, enable_rsi=True)
    ...
    def test_rsi_disabled_mode(self):
        ...
        filter_no_rsi = LiquidityStrategyFilter(gates, enable_rsi=False)
