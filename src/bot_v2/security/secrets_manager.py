...
class SecretsManager:
    ...
    def _initialize_encryption(self):
        ...
        try:
            self._cipher_suite = Fernet(encryption_key.encode() if isinstance(encryption_key, str) else encryption_key)
    ...
    def _store_to_file(self, path: str, secret: Dict[str, Any]):
