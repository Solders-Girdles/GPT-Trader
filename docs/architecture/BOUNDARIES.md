...
| Feature slices (business logic) | `src/gpt_trader/features/` (live_trade, intelligence, data, optimize, strategy_dev, strategy_tools) | Trading logic, strategies, guard stack, optimization workflows. |
