...
class DemoModeConfig:
    ...
    def is_demo_mode() -> bool:
        ...
        return (
            os.getenv("DEMO_MODE", "false").lower() in ("true", "1", "yes") or
            os.getenv("ALPACA_API_KEY_ID", "").startswith("DEMO_")
        )
    ...
    @staticmethod
    def validate_for_demo() -> tuple[bool, Optional[str]]:
...
def check_demo_mode_restrictions(operation: str) -> tuple[bool, Optional[str]]:
