...
from bot_v2.features.live_trade.liquidation_monitor import (
    LiquidationMonitor, MarginInfo, LiquidationRisk, create_test_margin_info
)
...
class TestLiquidationMonitor:
    ...
    def test_risk_assessment_safe(self):
        ...
        margin_info = create_test_margin_info(
            current_price=50000.0,  # Same as entry
