.PHONY: dev-up dev-down lint fmt fmt-check lint-fix format-lint-fix typecheck docs-audit tui-css-check test-guardrails ci-required test smoke preflight preflight-readiness dash cov clean clean-dry-run scaffold-slice \
