...
class MLEnhancedAllocator(Allocator):
    ...
    def __init__(self,
                 ...
                 db_manager=None,
                 optimizer: Optional[MarkowitzOptimizer] = None,
        ...
        if config is None:
            config = ComponentConfig(
                component_id='ml_enhanced_allocator',
                component_type='allocator'
            )
    ...
    def allocate(self,
                ...
                capital: float = 100000) -> Dict[str, float]:
        ...
        if self.regime_detector and current_features is not None:
            ...
            regime_confidence = confidence[-1] if isinstance(confidence, (list, np.ndarray)) else confidence
        ...
        if signals:
            active_universe = [
                ...
                if asset in signals and abs(signals.get(asset, 0)) > 0.1
            ]
        ...
        try:
            ...
            self.logger.info(f"Optimization complete - Sharpe: {metrics.get('sharpe_ratio', 0):.2f}, "
    ...
    def _adjust_weights_by_signals(self,
    ...
    def _weights_to_positions(self,
                             weights: Dict[str, float],
