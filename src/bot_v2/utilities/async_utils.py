    ...
    def decorator(func: Callable[..., Coroutine[Any, Any, T]]) -> Callable[..., Coroutine[Any, Any, T]]:
        ...
        async def wrapper(*args: Any, **kwargs: Any) -> T:
            try:
                ...
                raise asyncio.TimeoutError(f"Operation timed out after {timeout}s") from e
        return wrapper
    return decorator
...
class AsyncRetry:
    ...
    async def execute(self, coro: Callable[..., Coroutine[Any, Any, T]], *args: Any, **kwargs: Any) -> T:
...
def run_async_if_needed(func: Callable[..., T], *args: Any, **kwargs: Any) -> T | Coroutine[Any, Any, T]:
