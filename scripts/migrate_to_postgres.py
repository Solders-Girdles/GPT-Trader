...
class MigrationConfig:
    ...
    postgres_password: str = "trader_password_dev"
    batch_size: int = 1000
    validate: bool = True
    dry_run: bool = False
...
class DatabaseMigrator:
    ...
    def _migrate_table(self, source_conn: sqlite3.Connection, 
                      target_cursor, source_table: str, 
                      target_table: str, column_mapping: Dict):
    ...
    def validate_migration(self):
        ...
        for pg_table, sqlite_table in validations:
            ...
            if pg_count != sqlite_count:
                logger.warning(f"Row count mismatch for {pg_table}: PostgreSQL={pg_count}, SQLite={sqlite_count}")
...
def main():
    ...
    parser.add_argument('--sqlite-dir', type=Path, default=Path('.'), 
                       help='Directory containing SQLite databases')
    parser.add_argument('--postgres-host', default='localhost',
                       help='PostgreSQL host')
    parser.add_argument('--postgres-port', type=int, default=5432,
                       help='PostgreSQL port')
    parser.add_argument('--postgres-db', default='gpt_trader',
                       help='PostgreSQL database name')
    parser.add_argument('--postgres-user', default='trader',
                       help='PostgreSQL username')
    parser.add_argument('--postgres-password', default='trader_password_dev',
