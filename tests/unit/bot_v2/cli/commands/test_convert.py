...
class TestHandleConvert:
    ...
    def test_successful_conversion(self, mock_shutdown, mock_bot_with_account_manager, mock_parser, capsys):
    ...
    @patch("bot_v2.cli.commands.convert.ensure_shutdown")
    def test_conversion_output_is_json(self, mock_shutdown, mock_bot_with_account_manager, mock_parser, capsys):
    ...
    @patch("bot_v2.cli.commands.convert.ensure_shutdown")
    def test_conversion_with_whitespace(self, mock_shutdown, mock_bot_with_account_manager, mock_parser):
    ...
    @patch("bot_v2.cli.commands.convert.ensure_shutdown")
    def test_conversion_exception_raised(self, mock_shutdown, mock_bot_with_account_manager, mock_parser, caplog):
        """Test exception during conversion is raised and logged."""
        import logging

        mock_bot_with_account_manager.account_manager.convert.side_effect = Exception("Conversion failed")
    ...
    @patch("bot_v2.cli.commands.convert.ensure_shutdown")
    def test_conversion_with_decimal_amount(self, mock_shutdown, mock_bot_with_account_manager, mock_parser):
    ...
    @patch("bot_v2.cli.commands.convert.ensure_shutdown")
    def test_conversion_commit_flag(self, mock_shutdown, mock_bot_with_account_manager, mock_parser):
    ...
    @patch("bot_v2.cli.commands.convert.ensure_shutdown")
    def test_shutdown_called_on_parse_error(self, mock_shutdown, mock_bot_with_account_manager, mock_parser):
    ...
    @patch("bot_v2.cli.commands.convert.ensure_shutdown")
    def test_conversion_with_colons_in_amount(self, mock_shutdown, mock_bot_with_account_manager, mock_parser):
