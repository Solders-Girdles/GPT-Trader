...
from gpt_trader.data_providers.coinbase.provider import (
    CoinbaseDataProvider,
)
from gpt_trader.data_providers.coinbase.factory import create_coinbase_provider
...
class TestCoinbaseDataProvider:
    ...
    def test_provider_init_with_streaming_enabled(self) -> None:
        ...
        with patch("gpt_trader.features.brokerages.coinbase.market_data_service.CoinbaseTickerService"):
            with patch("gpt_trader.features.brokerages.coinbase.market_data_service.TickerCache"):
    ...
    def test_setup_streaming_success(self) -> None:
        ...
        with patch("gpt_trader.features.brokerages.coinbase.market_data_service.CoinbaseTickerService") as mock_service:
            with patch("gpt_trader.features.brokerages.coinbase.market_data_service.TickerCache") as mock_cache:
    ...
    def test_setup_streaming_failure(self) -> None:
        ...
        with patch(
            "gpt_trader.features.brokerages.coinbase.market_data_service.CoinbaseTickerService",
    ...
    def test_get_current_price_websocket_fresh(self) -> None:
        ...
        with patch("gpt_trader.features.brokerages.coinbase.market_data_service.CoinbaseTickerService"), \
             patch("gpt_trader.features.brokerages.coinbase.market_data_service.TickerCache"):
            provider = CoinbaseDataProvider(enable_streaming=True)
    ...
    def test_get_multiple_symbols_with_streaming(self) -> None:
        ...
        with patch("gpt_trader.features.brokerages.coinbase.market_data_service.CoinbaseTickerService") as mock_service_cls, \
             patch("gpt_trader.features.brokerages.coinbase.market_data_service.TickerCache"):
            provider = CoinbaseDataProvider(enable_streaming=True)
            
            # Configure the mock service instance returned by constructor
            ...
            # Update the provider's reference to the mock service (though it should be the same)
...
class TestCreateCoinbaseProvider:
    ...
    def test_create_mock_provider_env_disabled(self) -> None:
        ...
        with patch("gpt_trader.data_providers.MockProvider") as mock_provider:
    ...
    def test_create_real_provider_env_enabled(self) -> None:
        ...
        with patch("gpt_trader.data_providers.coinbase.provider.CoinbaseDataProvider") as mock_provider:
            create_coinbase_provider()
