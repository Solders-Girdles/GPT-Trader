...
def test_get_orchestration_logger():
    ...
    assert logger.name == "bot_v2.json.test_component"
...
def test_log_trading_operation(mock_get_log_context):
    ...
    with patch("bot_v2.logging.orchestration_helpers.get_orchestration_logger") as mock_logger:
        mock_log = MagicMock()
...
def test_with_trading_context_decorator():
    ...
    def test_function():
        from bot_v2.logging.correlation import get_correlation_id, get_domain_context
...
def test_with_symbol_context_decorator():
    ...
    def test_function():
        from bot_v2.logging.correlation import get_domain_context
