...
class TestExecutionHealthAlerts:
    ...
    def test_circuit_breaker_alert(self, alert_manager, mock_app, test_state):
        """Test circuit breaker open alert."""
        # Set up resilience data with circuit breaker open
        test_state.resilience_data = MagicMock()
        test_state.resilience_data.any_circuit_open = True
    ...
    def test_circuit_breaker_no_alert_when_closed(self, alert_manager, mock_app, test_state):
        """Test no alert when circuit breaker is closed."""
        test_state.resilience_data = MagicMock()
        test_state.resilience_data.any_circuit_open = False
    ...
    def test_execution_critical_alert(self, alert_manager, mock_app, test_state):
        """Test execution critical alert when success rate drops below 80%."""
        test_state.resilience_data = MagicMock()
        test_state.resilience_data.any_circuit_open = False
        test_state.execution_data = MagicMock()
        test_state.execution_data.submissions_total = 10
        test_state.execution_data.success_rate = 70.0  # Below 80%
    ...
    def test_execution_critical_requires_sample_size(self, alert_manager, mock_app, test_state):
        """Test execution critical alert requires minimum sample size."""
        test_state.resilience_data = MagicMock()
        test_state.resilience_data.any_circuit_open = False
        test_state.execution_data = MagicMock()
        test_state.execution_data.submissions_total = 3  # Below threshold of 5
        test_state.execution_data.success_rate = 50.0
    ...
    def test_execution_degraded_alert(self, alert_manager, mock_app, test_state):
        """Test execution degraded alert when success rate is 80-95%."""
        test_state.resilience_data = MagicMock()
        test_state.resilience_data.any_circuit_open = False
        test_state.execution_data = MagicMock()
        test_state.execution_data.submissions_total = 20
        test_state.execution_data.success_rate = 90.0  # Between 80% and 95%
    ...
    def test_execution_degraded_requires_sample_size(self, alert_manager, mock_app, test_state):
        """Test execution degraded alert requires minimum sample size."""
        test_state.resilience_data = MagicMock()
        test_state.resilience_data.any_circuit_open = False
        test_state.execution_data = MagicMock()
        test_state.execution_data.submissions_total = 5  # Below threshold of 10
        test_state.execution_data.success_rate = 90.0
    ...
    def test_p95_latency_alert(self, alert_manager, mock_app, test_state):
        """Test p95 latency spike alert."""
        test_state.resilience_data = MagicMock()
        test_state.resilience_data.any_circuit_open = False
        test_state.execution_data = MagicMock()
        test_state.execution_data.submissions_total = 20
        test_state.execution_data.success_rate = 98.0  # Healthy
        test_state.execution_data.p95_latency_ms = 750.0  # Above 500ms
    ...
    def test_p95_latency_no_alert_when_normal(self, alert_manager, mock_app, test_state):
        """Test no p95 latency alert when latency is normal."""
        test_state.resilience_data = MagicMock()
        test_state.resilience_data.any_circuit_open = False
        test_state.execution_data = MagicMock()
        test_state.execution_data.submissions_total = 20
        test_state.execution_data.success_rate = 98.0
        test_state.execution_data.p95_latency_ms = 200.0  # Normal
    ...
    def test_retry_rate_alert(self, alert_manager, mock_app, test_state):
        ...
        test_state.execution_data.success_rate = 98.0  # Healthy
        test_state.execution_data.p95_latency_ms = 200.0  # Normal
        test_state.execution_data.retry_rate = 0.8  # Above 0.5
    ...
    def test_retry_rate_no_alert_when_normal(self, alert_manager, mock_app, test_state):
        ...
        test_state.execution_data.submissions_total = 20
        test_state.execution_data.success_rate = 98.0
        test_state.execution_data.p95_latency_ms = 200.0
        test_state.execution_data.retry_rate = 0.2  # Normal
    ...
    def test_execution_alerts_handle_missing_data(self, alert_manager, mock_app, test_state):
    ...
    def test_execution_alerts_have_system_category(self, alert_manager, mock_app, test_state):
