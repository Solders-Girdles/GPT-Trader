...
class BacktestReporter:
    ...
    def generate_summary(self) -> str:
        ...
        lines = [
            ...
            f"  Net Profit Factor:  {stats.net_profit_factor:.2f}",
            f"  Fee/Trade:          ${stats.fee_drag_per_trade:,.2f}",
            "",
            "COSTS",
            "-" * 40,
    ...
    def generate_csv_row(self) -> dict[str, str | int | float]:
        ...
        return {
            ...
            "net_profit_factor": float(stats.net_profit_factor),
            "fee_drag_per_trade": float(stats.fee_drag_per_trade),
