...
def detect_double_top(data: pd.DataFrame, lookback: int = 20) -> Optional[PricePattern]:
    """
...
def detect_double_bottom(data: pd.DataFrame, lookback: int = 20) -> Optional[PricePattern]:
    """
...
def detect_head_shoulders(data: pd.DataFrame, lookback: int = 30) -> Optional[PricePattern]:
    """
...
def detect_triangle(data: pd.DataFrame, lookback: int = 20) -> Optional[PricePattern]:
    """
...
def detect_flag(data: pd.DataFrame, lookback: int = 15) -> Optional[PricePattern]:
    """
    Detect flag pattern.
